...
| Angelo | Decidere sullo splash in scuro (variante `dark` del plugin `expo-splash-screen`): oggi resta chiaro con l'arte v1 | fuori da questo piano |
