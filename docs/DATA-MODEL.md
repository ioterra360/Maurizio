...
| `photo_front_path` | text | Chiave della foto del FRONTE (`<user_id>/<memory_id>-front.jpg`, migration 20260908100000); nel ripasso si vede subito accanto al termine, `photo_path` solo dopo la risposta. Stesso bucket, stesse policy, stesso gate di piano. |
