 ...
 * tempo libero? Aggiungi una nuova nozione alla cartella", con il bottone
 * che apre Nuovo ricordo sulla cartella. Il tasto "Esercitati" e' stato
 * tolto l'8/9/2026 su richiesta di Angelo (la modalita' practice del
 * review-store resta, ma nessuna schermata la avvia).
